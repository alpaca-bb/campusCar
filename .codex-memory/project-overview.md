...
- Important fields:
  ...
  - `HOVERBOARD_FRONT_DEVICE`: STM32 driver serial device
...
- `hardware/hoverboard_driver`: ROS2 control driver for STM32 single-UART hoverboard-style chassis
...
- New STM32 chassis uses a single local UART, not a chassis IP/SSH hop.
