 ...
 *
 * Modified for CampusCar project:
 * - UART7 (PE7/PE8) connects to ESC driver board USART2 (PA3/PA2)
 * - UART1 is reserved for NUC communication
...
extern UART_HandleTypeDef huart7;  /* UART7 connects to ESC, not UART1 */
...
{
  HOVER_LinkInit(&hoverLink, &huart7);  /* Use UART7 for ESC control */
